...
type Server struct {
	...
	client     clientpb.CryptoWalletClientServiceServer
}

func New(cfg grpcServer.Config, client clientpb.CryptoWalletClientServiceServer) *Server {
	return &Server{
		cfg:    cfg,
		client: client,
	}
...
func (s *Server) Start(ctx context.Context) (err error) {
	...
	clientpb.RegisterCryptoWalletClientServiceServer(s.grpcServer, s.client)
